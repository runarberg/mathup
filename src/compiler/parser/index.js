 ...
 * @property { LiteralAttrs } [attrs]
 *
 * @typedef {IdentLiteral | NumberLiteral | OperatorLiteral | SpaceLiteral | TextLiteral} Literal
 * @typedef { Sentence | Term | FencedGroup | MatrixGroup | UnaryOperation | BinaryOperation | TernaryOperation | Literal } Node
 */
