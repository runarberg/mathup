/*! ascii2mathml v0.2.6 | (c) 2015 (MIT) | https://github.com/runarberg/ascii2mathml */
...
var isgroupStart = syntax.isgroupStart,
...
function ascii2mathml(asciimath, options) {
  ...
  if (options.annotate) {
    ...
    var parsed = parse(asciimath.trim(), ""),
        mathml = parsed === getlastel(parsed) ? parsed : mrow(parsed);
...
function makeParse(options) {
  ...
  function parseone(ascii, grouped, lastel) {
    ...
    if (ascii.startsWith("sqrt")) {
      ...
      var _ref = isgroupStart(ascii) ? syntax.splitNextGroup(ascii) : syntax.splitNextVert(ascii);
    ...
    if (rest && rest.trimLeft().match(/\.?[\^_]/)) {
      ...
      if ((lastel ? !lastel.match(/m(sup|over)/) : true) && rest.trimLeft().startsWith("_") && !rest.trimLeft()[1].match(/[|_]/)) {
        ...
        var _ref3 = splitNextSubscript(el, rest);
        ...
        var _ref4 = splitNextUnderscript(el, rest);
        ...
        var _ref5 = splitNextSuperscript(el, rest);
        ...
        var _ref6 = splitNextOverscript(el, rest);
  ...
  function splitNextFraction(_x, _x2) {
    ...
    _function: while (_again) {
      ...
      var el = _x,
          rest = _x2;
      bevelled = rem = next = ml = ascii = split = _ref = _ref2 = undefined;
  ...
  function parsecell(_x, _x2) {
    ...
    _function: while (_again) {
      ...
      var cell = _x,
          acc = _x2;
      _parseone = _parseone2 = mathml = rest = undefined;
      ...
      var _parseone = parseone(cell);

      var _parseone2 = _slicedToArray(_parseone, 2);

      var mathml = _parseone2[0];
...
},{"./lib/lexicon":2,"./lib/syntax":3,"babel/polyfill":96}],2:[function(require,module,exports){
"use strict";
...
},{"./lexicon":2}],4:[function(require,module,exports){
(function (global){
"use strict";
